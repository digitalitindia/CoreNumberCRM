  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans selection:bg-indigo-500/30">
      ...
      <header className="sticky top-0 z-20 px-6 py-2.5 flex items-center justify-between gap-4 bg-white/80 backdrop-blur-xl border-b border-slate-200">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <button 
            ...
            className="p-2 lg:p-2.5 text-slate-600 bg-slate-100/70 hover:bg-slate-200/80 rounded-xl hidden md:flex items-center justify-center transition-all duration-200 focus:ring-2 focus:ring-indigo-500/30 active:scale-95"
      ...
      <div className="flex pb-20 md:pb-0 relative z-10 w-full">
        ...
        {/* Main Content Area */}
        <main className={`flex-1 ${isSidebarOpen ? 'md:ml-64' : 'md:ml-0'} p-3 sm:p-6 md:p-8 w-full max-w-[100vw] overflow-hidden transition-all duration-300 ease-in-out`}>
          {isSettingsOpen ? (
