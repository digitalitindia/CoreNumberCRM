    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] bg-slate-50/40 backdrop-blur-xl border border-slate-200 rounded-3xl shadow-2xl p-8 md:p-10 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center mb-5 shadow-lg shadow-purple-500/20">
        ...
        <form onSubmit={handleAuth} className="space-y-5">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-white/50 border border-slate-200/50 rounded-xl text-slate-900 focus:border-blue-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all placeholder-slate-500 text-base"
          ...
          <div className="pt-4 flex flex-col gap-4">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-purple-500 text-slate-900 py-3.5 rounded-xl font-bold text-[15px] transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-purple-500/25 disabled:opacity-70 disabled:hover:scale-100 flex justify-center items-center h-12"
            >
              {loading ? (
